        ...
        {loading ? (
          ...
          localConversations.map((conversation: any) => (
            <div
              ...
              onClick={() => !conversation.isBlocked && onSelectConversation(conversation.conversationId)}
              className={cn(
                ...
                conversation.isBlocked && "opacity-50 cursor-not-allowed"
              )}
            >
                ...
                <div className="flex items-center justify-between">
                  <h3 className="font-medium truncate">
                    ...
                    {conversation.isBlocked && (
                      <span className="ml-2 text-xs text-red-500">(Đã bị chặn)</span>
                    )}
                  </h3>
